...
\tikzset{external/prefix={chapters/hpsg-handbook.for.dir/}}
% all the tikz figures that are not done by forest
%\tikzset{external/figure name={hpsg-handbook-tikz}}
% all the forest figures
\forestset{external/master=hpsg-handbook}
% will be overwritten in chapters when compiled standalone:
\forestset{external/master dir={chapters/}}
