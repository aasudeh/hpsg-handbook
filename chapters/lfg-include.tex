%% Time-stamp: <2020-05-12 13:15:30 admin>
%% -*- coding:utf-8 -*-
...
For example, \citet{bresnan+mchombo:1987} argue that the \ili{Chiche\^{w}a} (Bantu) object marker (\featt{OM}) is an incorporated pronoun, while the subject marker (\featt{SM}) alternates between agreement and incorporated pronoun, as in this example: 
...
The generalized quantifier functions associated with \word{everybody} and \word{somebody} are, respectively, \func{every} and
